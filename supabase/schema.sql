...
create policy "Users can read appointments for their patient scope"
...
create policy "Users can read documents for their patient scope"
on public.documents for select using (true);
create policy "Users can insert documents"
on public.documents for insert with check (true);

create policy "Users can read reminders for their patient scope"
on public.reminders for select using (true);
create policy "Users can insert reminders"
on public.reminders for insert with check (true);

create policy "Users can read caregiver access records"
on public.caregiver_access for select using (true);
create policy "Users can upsert caregiver access"
on public.caregiver_access for insert with check (true);

create policy "Users can read timeline events"
on public.timeline_events for select using (true);
create policy "Users can add timeline events"
